...
abstract class NetworkExceptions with _$NetworkExceptions {
  ...
  static NetworkExceptions handleResponse(Response? response) {
    ...
    switch (statusCode) {
      ...
      case 401:
      case 403:
        return NetworkExceptions.unauthorizedRequest(error.messageEN!);
      case 404:
        return NetworkExceptions.notFound(error.messageEN!);
      case 409:
        return const NetworkExceptions.conflict();
      case 408:
        return const NetworkExceptions.requestTimeout();
      case 422:
        return NetworkExceptions.unprocessableEntity(error.messageEN!);
      case 500:
